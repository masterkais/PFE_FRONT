...
export class GroupService {
  ...
  private apiURL = 'http://127.0.0.1:8080/group';
  headers: any = '';
  ...
  getAll(){
    ...
    return this.httpClient.get(this.apiURL+"/groups",{headers:new HttpHeaders({'Authorization':this.jwToken})});
...
save(group:any){
  if(this.jwToken==null){this.loadToken();}
  console.log("jwt pour get"+this.jwToken)
  return this.httpClient.post(this.apiURL,group,{headers:new HttpHeaders({'Authorization':this.jwToken})});
